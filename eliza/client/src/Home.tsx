            ...
            <main className="flex-1">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="space-y-8">
                                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black title-gradient" style={{ lineHeight: '1.2' }}>
                                    Revolutionizing DeFi with AI-Powered Agent Swarms on Sonic
                                </h1>
                                <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
                                    Simplify your DeFi experience with the power of Multi-Agent Systems (MAS) on Sonic
                                </p>
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                                    <Button
                                        size="lg"
                                        onClick={() => handleExternalLink('https://t.me/supersonicdemo_bot')}
                        ...
                        <div className="flex flex-col items-center space-y-8">
                            <div className="w-full max-w-5xl bg-background rounded-lg p-8 border border-white/[0.08]">
                                <img
                                    ...
                                    alt="SuperSonic Architecture Diagram"
                ...
                <section className="py-24 space-y-12">
                    <div className="container text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Seamlessly connected with the leading platforms and protocols in the Sonic ecosystem
                        </p>
                    </div>
                    <LogoCarousel />
                </section>
                ...
                <section id="pricing" className="container py-24 space-y-12">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            SuperSonic is and will always be open source! We strongly encourage users to self-host their own instance.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                href: "https://github.com/nicoware-dev/supersonic",
                                featured: true
                            },
                            {
                                title: "Free Tier",
                ...
                <section id="opensource" className="relative py-24">
                    ...
                    <div className="container relative space-y-12">
                        <div className="text-center space-y-4">
                            ...
                            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            SuperSonic is an open-source initiative. We invite developers and contributors to help us expand the MAS ecosystem and redefine DeFi automation together.
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <Button
                                ...
                                size="lg"
                                className="border-[#27272A] hover:bg-[#7f00ff]/10 hover:border-[#7f00ff]/50 hover:text-[#7f00ff] transition-all duration-300 w-full sm:w-auto"
                                onClick={() => handleExternalLink('https://discord.gg/dCtktdkt6J')}
                            >
                    ...
                    <div className="container relative space-y-12">
                        ...
                        <div className="flex flex-col items-center gap-8">
                            ...
                            <Button
                                ...
                                onClick={() => handleExternalLink('https://t.me/supersonicsales_bot')}
                            >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-center gap-4 mt-4">
                                ...
                                <a
                                    href="https://discord.gg/dCtktdkt6J"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                ...
                                <a
                                    href="https://linktr.ee/Super_Sonic"
                                    className="w-6 h-6 flex items-center justify-center"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
