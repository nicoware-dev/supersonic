...
import sonicExpertImg from "./assets/agents/Sonic Expert.png";
...
const agentCategories: Record<string, AgentCategory> = {
    ...
    public: {
        ...
        agents: [
            {
                name: "Metrics Agent",
                description: "Comprehensive analytics platform providing real-time insights for Sonic protocols",
            ...
            {
                name: "Sonic Expert",
                description: "Specialized knowledge base for Sonic Network",
                capabilities: [
                    "Protocol guidance",
                    "Gas optimization",
                    "Bridge operations",
        ...
        <div className="min-h-screen bg-background">
            ...
            <div className="py-16 container space-y-20">
                <div className="text-center space-y-6">
                    <h1 className="text-5xl font-black title-gradient">SuperSonic Agent Directory</h1>
                    <p className="text-xl text-muted-foreground/90 max-w-3xl mx-auto leading-relaxed">
                        Explore our comprehensive suite of AI agents designed to revolutionize DeFi operations on Sonic.
                    </p>
                </div>
